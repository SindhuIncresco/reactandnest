...
import Image from "./applelogo.png";
...
function Module({ position, company, location ,date}) {
  ...
  return (
    <div className=" w-844 h-204 top-316 left-478 mb-5">
      ...
      <div class="header col-span-12  bg-[#323C52] rounded-lg r">
      
        <div class="flex  text-sm text-gray-400">
          <div class="  m-4 w-20 h-20 rounded-3xl">
          <img src={Image} className="w-20 h-20 rounded-3xl" alt="Logo" />
          </div>
          <div class="flex-1 inline-flex items-center justify-between">
            <div className=" flex pl-3 flex-col text-white ">
              <div className=" inline-flex flex-nowrap  text-lg my-2 font-bold leading-none">
                {position}
              </div>
                ...
                <span className="mr-3 inline-flex ">{location}</span>
            </div>
            <div class=" flex-1 inline-flex place-items-center pr-3 justify-end">
              <div>
                <div className=" text-white text-xl subpixel-antialiased m-5 ">{t('mainscreen.Skillmatch')}</div>
              </div>
              <div class="m-5">
        ...
        <div class="footer col-span-12  rounded-b bg-[#525D7966] px-10 pb-3 ">
        <div class="flex pt-2 allign-justify text-sm text-gray-400">
          ...
          <div class="  flex-1 inline-flex place-items-center border-white justify-end">
            <div>
              <button  class="flex-no-shrink bg-teal-600  hover:bg-slate-400  px-5  py-2 pl-7 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider  text-white rounded-full transition ease-in duration-300">{t('mainscreen.apply_now')}</button>
            </div>
            <div class="pl-2 h-6">
